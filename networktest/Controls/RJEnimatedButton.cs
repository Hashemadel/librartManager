...
{
    /*[DefaultEvent("_Clic")]*/
    public class RJEnimatedButton : Button
    {
        ...
        public RJEnimatedButton()
        {

            DoubleBuffered = true;
            t.Interval = 60;
            t.Start();
            t.Tick += (s, e) => { gradientAngle = gradientAngle % 360 + 1; };
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            //Gradient
            pevent.Graphics.FillPath(new LinearGradientBrush(ClientRectangle,gradientTopColor,gradientBottomColor,gradientAngle), gp);
